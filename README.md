...
![Base Persona Logo](src/components/Screenshots/Logo.png)

### Get Started

The Get Started page prompts users to connect their Base wallet to begin their Persona's evolution.

![Get Started](src/components/Screenshots/Home.png)
